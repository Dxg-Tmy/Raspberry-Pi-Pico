...
time.sleep(.01)
LCD_display.text(im_font_8x8, "ST7789 SPI 240*240 IPS", 10, 100)
time.sleep(.01)
LCD_display.text(im_font_8x8, "eetree.cn", 10, 110)
time.sleep(.01)
LCD_display.text(im_font_8x8, "Piday, let's have fun!", 10, 120)
time.sleep(.01)
